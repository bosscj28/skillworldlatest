...
public class FragmentComplete extends Fragment {
    ...
    private void init(View v){
        ...
        complete_list = (ListView)v.findViewById(R.id.complete_list);
        adapter = new PaymentAdapter(context,paymentModels);
        complete_list.setAdapter(adapter);

        String url = Utils.BASE_URL + Utils.GET_PAYMENTS + "?userid="+session.getUserId()+"&status=Completed";
        Log.d("ankit",url);
